<template>
    <div class="_w">
        <div class="w">
            ...
            <div class="q">
                <div class="s">
                    This courses are for old student. Any course created here will not be offered in all department. (depid_0)
                </div>
            </div>
        </div>
    </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                acadProgramId: 0,
                programTypeId: '',
                course: { name: '', name_alias: '', total_units: 0, is_available: false }
            }
        },
        computed: {
            isFormOkay() {
        ...
        methods: {
            ...
            goSaveCourse() {
                ...
                this.$http.post('course/', { department: null, academic_program: this.acadProgramId, ...this.course, program_type: this.programTypeId }).then(res => {
...
<style scoped>
    ...
    .q .s { height: 100%; padding: 20px 12px; color: #606060; line-height: 125%; }
