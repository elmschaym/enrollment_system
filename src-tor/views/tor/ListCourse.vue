    ...
    export default {
        ...
        methods: {
            ...
            fetchCourses() {
                ...
                this.$http.get('course/?action='+ this.queryAction +'&start='+ this.listStart +'&limit='+ this.listLimit +'&type='+ this.queryType +'&query='+ this.queryString +'&refer=department-old&course_fields=id,name,name_alias,program_type,total_units,acadprogram&department_fields=id,name,name_alias&acadprogram_fields=id,name&coursef_is_available=false').then( res => { 
...
<style scoped>
    ...
    .wrap-m .w { height: 100%; display: grid; grid-template-columns: auto 200px; }
    ...
    .list-o .data .tbl .thd, .list-o .data .tbl .ttr { display: grid; grid-template-columns: 50px auto 120px 180px 70px }
