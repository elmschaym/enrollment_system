		...
		<div class="w">
			<div class="x">
				<ul>
					<li>
						<div class="l">
							<div class="n" @click="toMenu('adm')">Lister</div>
						</div>
					</li>
					<li>
						<div class="l">
							<div class="n" @click="toMenu('dep')">Create</div>
					...
					<li>
						<div class="l">
							<div class="n" @click="toMenu('fin')">Enroll</div>
					...
					<li>
						<div class="l">
							<div class="n" @click="goLink('sub-index', 'sub')">Instructors</div>
						</div>
					</li>
					<li>
						<div class="l">
							<div class="n" @click="goLink('cou-index', 'cou')">Offers</div>
						</div>
					</li>
				</ul>
			</div>
