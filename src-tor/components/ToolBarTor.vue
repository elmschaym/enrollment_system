		...
		<div class="w">
			<div class="x">
				<ul>
					<li>
						<div class="l">
							<div class="n" @click="goLink('cou-index', 'cou')">New</div>
						</div>
					</li>
					<li>
						<div class="l">
							<div class="n" @click="goLink('cou-index', 'cou')">List</div>
						</div>
					</li>
					<li>
						<div class="l">
							<div class="n" @click="goLink('cou-index', 'cou')">Assign</div>
						</div>
					</li>
					<li>
						<div class="l">
							<div class="n" @click="goLink('cou-index', 'cou')">Create</div>
						</div>
					</li>
					<li>
						<div class="l">
