<template>
	<div class="_com_us">
		<div class="sele" :style="styles[0] ? styles[0] : 'width: 100%;'">
			<div class="exit" v-show="isSelect && closer" @click="isSelect = false">
				&times;
			</div>
...
<style scoped>
	...
	.sele { color: #111; background-color: #fdfdfd; border: none; outline: none; cursor: pointer; border-style: solid; border-width: 1px; border-color: #f0f0f0 #eaeaea #d0d0d0 #eaeaea; position: relative; border-radius: 2px; padding: 6px 10px 6px 10px; height: 27px; }
	...
	.exit { position: absolute; bottom:  100%; left: 0; right:  0; height: 20px; background-color: #f0f0ea; color: #222; border: 1px solid #f0f0ea; display: grid; place-items: center }
</style>
