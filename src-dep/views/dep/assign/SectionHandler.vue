			...
			<div class="p">
				<div class="u">
					<div class="h">
						...
						<div class="butt">
							<button v-if="false">Print Schedule <v-icon name="print"></v-icon></button>
						</div>
					</div>
					<div class="r o">
						<div class="x">
...
<style scoped>
	...
	.p .h { padding: 10px 12px; border-bottom: 1px solid #d0d0c0; display: grid; grid-template-columns: 40px auto 128px; margin-bottom: 0px;}
	...
	.p .r.o { display: grid; grid-template-columns: auto 200px; border-bottom: 4px solid #c0c0ba; padding: 16px 10px; }
