...
<style scoped>
	...
	.p .g .r.n .name b { display: block; font-size: 12px; font-weight: 600; }
	.p .g .r.n .name span { display: block; font-size: 11px; color: #202020; }
	...
	.p .r.o .y .b { display: flex; flex-wrap: wrap; padding: 16px; justify-content: center; height: 175px; }
