...
<style scoped>
    ...
    .find input { display: block; color: #391e22; padding: 5px 10px; border: none; background-color: #fefefe; font-size: 11px; outline: none; border-radius: 5px 0 0 0; }
    .find button { display: block; color: #391e22; padding: 4px 8px 4px 2px; border: none; border-left: 1px solid #f0f0f0; border-bottom: 1px solid #f0f0f0; background-color: #fafafa; font-size: 11px; outline: none; cursor: pointer; border-radius: 0 5px 0 0; }
    ...
    .list .l:hover, .l.active { background-color: #fafaf8; }
