	...
	<div class="_pri _pri_ebf">
		<div class="head p">
			<div class="x">
				...
				<div class="n">Academic Status</div><div class="v">{{ enrollment.acad_status }}</div>
			</div>
			<div class="y">
			...
			<div class="z">
				...
				<div class="n ta-r">Semester</div><div class="v ta-r">{{ enrollment.semester }} Semester</div>
				<div class="n ta-r">Academic Year</div><div class="v ta-r">{{ enrollment.acad_year }}</div>
			</div>
		</div>
		<div class="head o">
			<div class="c">ENROLLMENT & BILLING FORM (EBF)</div>
		</div>
		<div class="head q">
			<div class="x">
				...
				<div class="n">Course</div><div class="v">{{ enrollment.admission.course.program_type +' '+ enrollment.admission.course.name_alias }}</div>
				<div class="n">Date Admitted</div><div class="v">{{ enrollment.admission.date_admitted }}</div>
			</div>
			<div class="y">
			</div>
			<div class="z">
		...
		<div class="data">
			<div class="x">
				...
				<div class="h">
					<div class="i" :key="i +'print'+ s.id" v-for="(s,i) in enrollment.billing[0].sect_enrol">
			...
			<div class="y">
				...
				<div class="h">
					<div class="i" :key="'mscprint'+ m.id" v-for="m in enrollment.billing[0].misc_bills">
						<div> &nbsp; &nbsp; {{ m.misc.name }}</div>
		...
		<div class="date">
			<div>Date Confirmed: <span>{{ enrollment.confirmed_at }}</span></div>
			<div>Date Printed: <span>{{ getTodate() }}</span></div>
			<div class="ta-r amt">Amount Due: <b>{{ tally.totalFees | currency }}</b></div>
		</div>
	</div>
</template>
