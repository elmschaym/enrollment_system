            ...
            <div class="data">
                <div class="tbl">
                    ...
                    <div class="tbd" v-else-if="list.length > 0">
                        <div class="ttr" @click="$router.push({ name: 'stu-view-index', params: { stuid : l.school_id }})" :key="l.school_id +'_'+ l.id" v-for="l in list">
    ...
    export default {
        ...
        methods: {
            ...
            fetchStudents() {
                ...
                this.$http.get('student/?action='+ this.queryAction +'&type='+ this.queryType +'&query='+ this.queryString +'&student_fields=id,school_id,firstname,middlename,lastname,gender,home_address,campus_address,civil_status,birthdate').then( res => { 
                    let data = res.data;
                    this.list = data;
                }).catch( () => {
...
<style scoped>
    ...
    .list-o .data .tbl .tbd { height: 440px; }
    ...
    .list-o .data .tbl .ttd { padding: 10px 10px 10px 10px; height: 30px; font-size: 11px; text-overflow: clip; overflow-x: hidden; white-space: nowrap; }
