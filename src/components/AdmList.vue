<template>
    <div>
        <div class="find-o">
            ...
            <div class="v">
                <input v-model="queryString" placeholder="Find student"/>
            ...
            <div class="data">
                <div class="tbl">
                    ...
                    <div class="tbd" v-else-if="list.length > 0">
                        <div class="ttr" @click="$router.push({ name: 'adm-view-admit', params: { admit_id : l.id}})" :key="l.id" v-for="l in list">
    ...
    export default {
        ...
        methods: {
            fetchAdmission() {
                ...
                this.$http.get('admission/?action='+ this.queryAction +'&type='+ this.queryType +'&query='+ this.queryString +'&admission_fields=id,date_admitted,status,student,course,academic_program&student_fields=school_id,firstname,middlename,lastname&course_fields=id,name&acadprogram_fields=id,name').then( res => {
...
<style scoped>
    ...
    .list-o .data .tbl .tbd { height: 440px; overflow-y: scroll; overflow-x: hidden; }
    .list-o .data .tbl .tbd::-webkit-scrollbar { width: 8px; display: block; }
    .list-o .data .tbl .tbd::-webkit-scrollbar-track { background: #f6f6f0; }
    .list-o .data .tbl .tbd::-webkit-scrollbar-thumb { background-color: #e7e7e0; }
