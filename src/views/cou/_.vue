<template>
    <div>
        <div class="cate-o">
            <div class="link">
                <ul>
                    <li @click="goName('adm-all')" :class="viewName == 'adm-all' || viewName == 'adm-index'? 'active' : ''"><div>Baccalaureate</div></li>
                    <li @click="goName('adm-probation')" :class="viewName == 'adm-probation' ? 'active' : ''"><div>Vocational</div></li>
                    <li @click="goName('adm-discharged')" :class="viewName == 'adm-discharged' ? 'active' : ''"><div>Technology</div></li>
                </ul>
            </div>
            <div class="make">
            </div>
