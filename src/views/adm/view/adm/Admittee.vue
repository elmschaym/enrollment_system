...
<style scoped>
    .wrap-v { height: auto; }
    .t { height: 100%; }
    .t { display: grid; grid-template-columns: 300px auto }
    .t .p { height: 100%; background-color: #fff; }
    .t .d { height: 100%; background-color: #f8f8f2; }
    ...
    .p .name span { font-size: 13px; font-weight: 600 }
    .p .name svg { float: right; width: 14px; height: 14px; margin-bottom: -2px; }

    .p .info { width: 240px; margin: 0 auto; border-top: 1px solid #fbfbfb; }
    .p .info .r { display: grid; grid-template-columns: 90px 10px 140px; font-size: 11px; border-bottom: 1px solid #fbfbfb; }
    .p .info .r .n { background-color: #f4f4f4; padding: 10px 6px; }
    .p .info .r .c { padding: 10px 0; background-color: #fefefe; text-align: center; }
    .p .info .r .v { padding: 10px 0; background-color: #fefefe; color: #000; }

    div.t .d {}

    .list { margin: 32px 16px; background-color: #fff; border: 1px solid #f5f5f0; min-height: 140px; }
    ...
    .list-o .data .tbl .tth { padding: 7px 10px; color: #111; text-align: left; font-size: 10px; background-color: #f5f5f0; font-weight: 600 }
