            ...
            <div class="data">
                <div class="tbl">
                    ...
                    <div class="tbd" v-else-if="faculties.length > 0">
                        <div class="ttr" :key="l.id" v-for="l in faculties" @contextmenu="facultyListCMenu($event, l)">
        ...
        methods: {
            ...
            facultyListCMenu(e, l) {
                ...
                let cmenu = new window.nw.Menu(),
                    items = [
                        { label: 'Teaching Load', click: () => this.$router.push({ name: 'dep-fac-teaching-load', query: { faculty_id: l.id } }) },
                        { label: 'Assign Section', click: () => this.$router.push({ name: 'dep-fac-assign-section', query: { faculty_id: l.id } }) },
...
<style scoped>
    ...
    .list-o .data .tbl .tbd { height: 440px; position: relative; }
    ...
    .list-o .data .tbl .tbd .ttr:hover { background-color: #fbfbf7; }
