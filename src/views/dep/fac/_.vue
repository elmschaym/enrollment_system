<template>
    <div class="wrap-z">
        <div class="cate-o">
            ...
            <div class="make">
                <span @click="goMake()" v-show="false">
                    <v-icon name="plus"></v-icon> New Student
                </span>
            </div>
        </div>
...
<style scoped>
    ...
    .cate-o { background-color: #fbfbf7; height: 32px; display: grid; grid-template-columns: auto 300px; border-bottom: 1px solid #eaeaea; }
    .link ul { display: block; margin: 0 16px; }
    .link ul li { display: inline-block; font-size: 11px; padding: 10px 12px;  }
    .link ul li.active { border-bottom: 2px solid #290e12; cursor: pointer; }
    .link ul li.click { cursor: pointer; }
