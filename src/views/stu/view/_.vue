        ...
        <div class="t">
            ...
            <div class="d">
                <div class="cate-o">
                    <div class="link">
                        <ul>
                            <li @click="goName('stu-view-index')" :class="viewName == 'stu-view-index' || viewName == 'stu-view-index'? 'active' : ''"><div>Admissions</div></li>
                            <li @click="goName('stu-view-enrol')" :class="viewName == 'stu-view-enrol' ? 'active' : ''"><div>Enrolments</div></li>
                            <li @click="goName('stu-view-infos')" :class="viewName == 'stu-view-infos' ? 'active' : ''"><div>Background</div></li>
                            <li @click="goName('stu-view-previ')" :class="viewName == 'stu-view-previ' ? 'active' : ''"><div>Previleges</div></li>
                            <li @click="goName('stu-view-organ')" :class="viewName == 'stu-view-organ' ? 'active' : ''"><div>Organizations</div></li>
                        </ul>
                    </div>
                    <div class="make">
                        <span>
...
<style scoped>
    ...
    div.t .p { background-color: #fbfbfb; height: calc(100vh - 48px); }
    div.t .d { background-color: #f0f0f0; height: calc(100vh - 48px); }
    ...
    .cate-o { background-color: #f8f8f8; height: 32px; display: grid; grid-template-columns: auto 100px; border-bottom: 1px solid #eaeaea; }
    ...
    .cate-o .link ul li.active { border-bottom: 2px solid #290e12; font-weight: bold; }
