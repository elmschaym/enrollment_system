<template>
    <div>
        <div class="cate-o">
            <div class="link">
                <ul>
                    <li @click="goName('stu-list-index')" :class="viewName == 'stu-list-index' || viewName == 'stu-list-index'? 'active' : ''"><div>Master</div></li>
                    <li @click="goName('adm-inpatient')" :class="viewName == 'adm-inpatient' ? 'active' : ''"><div>Undergraduates</div></li>
                    <li @click="goName('adm-probation')" :class="viewName == 'adm-probation' ? 'active' : ''"><div>Graduates</div></li>
                    <li @click="goName('adm-discharged')" :class="viewName == 'adm-discharged' ? 'active' : ''"><div>Previleged</div></li>
                </ul>
            </div>
            <div class="make">
                <span @click="goMake()">
                    <v-icon name="plus"></v-icon> Student
                </span>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            goMake() {
                this.$router.push({ name: 'stu-new-stude' });
            }
        }
    }
</script>
